...
Vagrant.configure("2") do |config|
  ...
  # ajout du'un script pour installer tomcat, maven et postgres
  config.vm.provision "shell", path: "scriptInstall.sh"
  config.vm.provision "shell", path: "scriptInstallJava.sh"
  config.vm.provision "shell", path: "scriptInstallMaven.sh"
